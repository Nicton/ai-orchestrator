---
confluence_url: https://shiptify.atlassian.net/wiki/spaces/TD/pages/631111701
...
## 🔗 Граф-метаданные
- **id:** `admin-app`
- **type:** overview · **domain:** Admin-App · **status:** implemented
- **confluence:** 631111701 · **repo:** `admin-app/README.md`
