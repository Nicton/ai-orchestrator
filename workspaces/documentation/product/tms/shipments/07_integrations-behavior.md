---
confluence_url: https://shiptify.atlassian.net/wiki/spaces/TD/pages/632225986
...
## 🔗 Граф-метаданные
- **id:** `tms.shipments.07_integrations-behavior`
- **type:** module-doc · **domain:** TMS · **status:** implemented
- **confluence:** 632225986 · **repo:** `tms/shipments/07_integrations-behavior.md`
